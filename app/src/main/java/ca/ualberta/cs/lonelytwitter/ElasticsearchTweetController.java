...
public class ElasticsearchTweetController {
   ...
   public static class GetTweetsTask extends AsyncTask<String, Void, ArrayList<Tweet>>{
        ...
        protected ArrayList<Tweet> doInBackground(String...search_strings){
            ...
            String query = "";
            if (search_strings[0] != "") {
                query = "{\"query\":{\"match\":{\"message\": \"" + search_strings[0] + "\"}}}";
            }

            //Note: im making a huge assumption here, that only the first search tem
            //will be used
            ...
            for (int i = 0; i < tweets.length; i++) {
                ...
                try {
                    ...
                    if (result.isSucceeded()) {
                        ...
                        Log.i("TO DO", "We actually failed here, adding a tweet");
                    }
                } catch (IOException e) {
                    e.printStackTrace();
                }
